...
public abstract class BaseConfigManager
    implements CoreConfig, DatabaseConfig, BungeeCordConfig, EmailConfig {
  ...
  private boolean mergeMap(
      java.util.Map<String, Object> configMap, java.util.Map<String, Object> defaultMap) {
    ...
    for (java.util.Map.Entry<String, Object> entry : defaultMap.entrySet()) {
      ...
      if (configVal == null) {
        ...
        if (mergeMap(
            (java.util.Map<String, Object>) configVal,
            (java.util.Map<String, Object>) defaultVal)) {
          changed = true;
        }
      }
    }
  ...
  public void reload() {
    ...
    String language =
        mainConfig.getString(ConfigConstants.Path.LANGUAGE, ConfigConstants.DEFAULT_LANGUAGE);
    i18n.setLocale(language.replace("_", "-"));
    i18n.reload();
  }
  ...
  public CoreConfig.SpawnLocation getSpawnLocation() {
    String locStr =
        mainConfig.getString(
            ConfigConstants.Path.SPAWN_LOCATION, ConfigConstants.DEFAULT_SPAWN_LOCATION);
    return parseSpawnLocation(locStr);
  }

  private CoreConfig.SpawnLocation parseSpawnLocation(String str) {
    ConfigHelper.LocationData data =
        ConfigHelper.parseLocationString(
            str,
